...
K_b(:,:,5) = 1;
K_b(:,:,6) = eye(60);
X = rand(60,4); Y = rand(60,4); alpha_b = 1/6*ones(6,1); v = 0.001; mu_2 = 20; K = 4;
...
while k<=20
    ...
    while 1
        ...
        if norm(X_prev2-X_prev) < 0.001 && norm(alpha_bprev2-alpha_bprev) < 0.001
            break;
        end
    end
