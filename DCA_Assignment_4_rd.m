...
X = rand(78,3); Y = rand(78,3); 
alpha_b = 1/17*ones(17,1); v = 0.001; 
mu_2 = 100; K = 3;
...
while k <= 1500
    while 1
        ...
        while 1
            ...
            if norm(X_prev-X) < 0.06 && norm(alpha_bprev-alpha_b) < 0.06
                break;
            end
        end
        if norm(X_prev2-X_prev) < 0.06 && norm(alpha_bprev2-alpha_bprev) < 0.06
            break;
        end
    end
    ...
    %a14 = length(find(idx(1:range_overall)==4));
    ...
    %a24 = length(find(idx(range_overall+1:2*range_overall)==4));
    ...
    %a34 = length(find(idx((2*range_overall)+1:3*range_overall)==4));
