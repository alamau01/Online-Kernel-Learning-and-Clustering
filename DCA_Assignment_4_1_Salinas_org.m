%DCA_Assignment_4_1_Salinas_org
    ...
    while 1
        ...
        while 1
            if mod(k,2) == 0
                ...
                norm1(k) = norm(X_prev-X,1);
                if norm(X_prev-X,1) <= 0.6 && norm(alpha_bprev-alpha_b,1) <= 0.6
                    break;
                end
            else
                Y_prev = Y;
                ...
                if norm(Y_prev-Y,1) <= 0.6
                    break;
                end
            end
        end
        if mod(k,2) == 0
            if norm(X_prev2-X_prev,1) <= 0.6 && norm(alpha_bprev2-alpha_bprev,1) <= 0.6
                break;
            end
        else
            if norm(Y_prev2-Y_prev,1) <= 0.6
                break;
            end
        end
    end
